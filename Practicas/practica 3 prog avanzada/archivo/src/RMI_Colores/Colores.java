...
public class Colores extends javax.swing.JFrame {
    private static Paso paso = new Paso();
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Colores().setVisible(true);
                 try {
                    RMI obj = new RMI(paso); //Crea una instancia de sí mismo como objeto a registrar pasandolo el paso
                    ...
                    System.out.println("El Objeto Estado ha quedado registrado");       //Mensaje de conexion
                } catch (Exception e) {
