...
public class Biblioteca extends javax.swing.JFrame {
    private Paso paso = new Paso(); //se crea el objeto paso para hacer las pausas
    private boolean botonPulsado1 = false; // cuando se incluya boton
    Semaphore semaforo = new Semaphore (15, true);
    Semaphore semaforoo = new Semaphore (1, true);
    /**
     * Creates new form Biblioteca
     */
    public Biblioteca() {
        initComponents();
        Libro libro=new Libro(semaforo, semaforoo);
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Biblioteca Semaforo");
